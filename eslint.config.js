...
const spaGlobals = {
  ...
  // 공통 컴포넌트
  Combobox: 'readonly', LinkedContracts: 'readonly', LinkedQuotes: 'readonly', LinkedProposals: 'readonly', LinkedSupport: 'readonly', LinkedPayments: 'readonly', ReadReceipts: 'readonly', ViewToggle: 'readonly', KpiBar: 'readonly', StageProgress: 'readonly', BulkPaste: 'readonly',
