...
const DETAIL = {
  ...
  data: {
    ...
    lifecycle: {
      materials: [
        { id: 11, material_name: '식각가스 C4F6 · Fab12', business_type: '식각가스', fab_line: '평택 P3', lifecycle_stage: 'specin', lifecycle_label: 'Spec-in', lifecycle_index: 3, current_gate: 'CS', current_gate_label: '고객 샘플', gates: [
          { gate_key: 'MRD', gate_label: '시장요구 정의', status: 'done', target_date: '2026-01-15', actual_date: '2026-01-10', late: false },
          { gate_key: 'CRP', gate_label: '개발 계획', status: 'done', target_date: '2026-02-15', actual_date: '2026-02-12', late: false },
          { gate_key: 'DOE', gate_label: '실험계획(DOE)', status: 'done', target_date: '2026-03-20', actual_date: '2026-03-18', late: false },
          { gate_key: 'ES', gate_label: '엔지니어링 샘플', status: 'done', target_date: '2026-04-30', actual_date: '2026-04-28', late: false },
          { gate_key: 'CS', gate_label: '고객 샘플', status: 'in_progress', target_date: '2026-07-20', actual_date: null, late: false },
          { gate_key: 'QUAL', gate_label: '품질 인증', status: 'pending', target_date: '2026-09-30', actual_date: null, late: false },
          { gate_key: 'MP', gate_label: '양산', status: 'pending', target_date: '2026-11-30', actual_date: null, late: false },
...
test('고객·제품 360뷰 — 라이프사이클 보드 + 수요·생산·수주 + 탭', async ({ page }) => {
  ...
  // 게이트=단일 소스: 현재 게이트(.ss-now)는 게이트 키(CS=고객 샘플) + '현재' 칩 표시
  await expect(page.locator('.lc-card .ss-now')).toContainText('CS');
